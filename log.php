    ...
    <body>
        <form class="login-form" action="includes/login.inc.php" method="POST">
            ...
            <div class="login-form__content">
                ...
                <input class="login-form__input" type="text" name="mail" placeholder="E-mail">
                <input class="login-form__input" type="password" name="pwd" placeholder="Password">
                <input class="login-form__input" type="password" name="pwd-repeat" placeholder="Repeat password">
                <button class="login-form__button" type="submit" name="login-submit">Login</button>
                <a href="signup.php" class="login-form__button">Signup</a>
            </div>
    </body>
